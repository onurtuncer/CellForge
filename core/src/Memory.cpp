...
namespace CellForge {
	...
	static CellForge::AllocationStats s_GlobalStats;
...
{
	return CellForge::Allocator::Allocate(size);
}
...
{
	return CellForge::Allocator::Allocate(size, desc);
}
...
{
	return CellForge::Allocator::Allocate(size, file, line);
}
...
{
	return CellForge::Allocator::Free(memory);
}
