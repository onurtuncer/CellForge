...
macro(cellforge_variables)
  ...
  # Off by default and inert unless both the option is enabled and an
  # include-what-you-use binary is found. IWYU is clang-based and does not
  # understand MSVC cl.exe invocations, so it only takes effect when compiling
  # with Clang.
  ...
  if(CELLFORGE_ENABLE_IWYU)
    if(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
      ...
      if(CELLFORGE_IWYU_EXECUTABLE)
        # -Xiwyu --mapping_file=...   : suppress umbrella-vs-detail-header noise for Boost/GTest (see cmake/iwyu/cellforge.imp)
        # -Xiwyu --cxx17ns            : collapse suggested namespace blocks to C++17 nested-namespace syntax
        # -Xiwyu --no_fwd_decls       : CellForge prefers full includes over forward declarations
        set(CMAKE_CXX_INCLUDE_WHAT_USE
            "${CELLFORGE_IWYU_EXECUTABLE}" "-Xiwyu" "--mapping_file=${CMAKE_CURRENT_LIST_DIR}/iwyu/cellforge.imp"
