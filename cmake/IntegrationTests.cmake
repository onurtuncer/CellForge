...
ExternalProject_Add(cellforge_integration_tests
...
# Register a top-level CTest entry that delegates to the test sub-build.
# Run `ctest` (or `cmake --build . --target RUN_TESTS`) after a full build.
add_test(
    NAME CellForge.Integration
    COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure -C $<CONFIG> --test-dir "${_TESTS_BUILD_DIR}"
)
